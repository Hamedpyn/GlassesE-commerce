      ...
      <div className="w-full gap-2 flex-wrap flex-col sm:flex-row max-w-350 p-10 flex justify-between">
        <div>
          <div className="flex flex-col items-start gap-4">
            <Image height={100} width={100} className="rounded" src="/Images/photo_2026-02-14_01-04-33.jpg" alt="لوگوی فروشگاه عینک رهام"
            />
        ...
        <div className="flex items-start pt-5">
          <Image height={100} width={100} className="rounded" src="/Images/license1.png" alt="مجوز اینماد" />
          <Image height={80} width={80} className="rounded" src="/Images/license2.svg" alt="عضو اتحادیه کشوری کسب و کار های دیجیتال" />
